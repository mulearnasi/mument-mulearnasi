...
export default function MuLearnQueryHub() {
  ...
  // --- SPLASH SCREEN (Aligned to Reference Design) ---
  if (showSplash) {
    return (
      <div className="fixed inset-0 z-[100] flex flex-col items-center justify-between bg-[#4A90FF] overflow-hidden py-24">
        <FloatingParticles variant="splash" />
        
        {/* Background Ripple/Circle Effect */}
        ...
        {/* Main Center Branding: Logo from public folder */}
  ...
  // --- MAIN HOME SCREEN (Full Screen Layout) ---
  return (
